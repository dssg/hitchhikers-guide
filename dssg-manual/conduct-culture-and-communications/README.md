...
> If you feel that you or anyone else is being harassed or treated unfairly, or have any other concerns related to this policy, please contact one of your **fellow advocates:** 
> Jane Zanzig (via private Slack message or by call/text at (206) 235-6912),
> or Rob Mitchum (via private Slack message or by call/text at (773) 484-9890).
...
This program strives to achieve three goals. We know that these goals are lofty. We do not presume or pretend to know the optimal way to achieve them, but we think it's worth trying. We want all of you to help us by actively contributing ideas to improve our program and achieve these goals more effectively. The goals are (in order of priority):
...
Our long-term, overarching, unifying goal, in the long term is that more of this type of work happen in the world, and for our fellows to be better equipped and more likely to use their skills for social good after going through the fellowship program. 

## Training Our Fellows  
**First and foremost, DSSG is a training program for fellows.** We believe that the best way to learn is by working on *real* projects, which is why you work in teams with other *real* people on a *real* project with a *real* partner. You will gain hands-on technical data science experience, but that’s not enough to do this type of work. This means that training includes all other aspects of the work, including working with project partners, understanding social issues, using social science methods, working collaboratively on a team, developing solutions in an agile way, and communicating your work effectively to technical and non-technical audiences.

We start the summer off with a week of intensive orientation, getting everyone acquainted with each other and the structure of the program, as well as up to speed with the tools and methods we will use. Training continues throughout the summer with lectures and workshops by staff, guest speakers, and fellow teachouts. Dedicated full-time data science and technical mentors, as well as project managers, will support and guide you throughout the summer. For more information on curriculum can be found [here](#curriculum).

In short, we want the summer to be a productive and collaborative experience for you, and will provide you with many resources; however, **your biggest resource will be the other fellows in your cohort**. Every fellow contributes their own wealth of experience and expertise, and we aim to foster a learning environment where everyone can share their knowledge and learn from one another.
   
## Introducing Data Science to the Social Sector  
We believe that data-driven decisionmaking isn’t reserved for companies selling online advertisements or banks trying to detect fraud. We know that data science can help governments, non-profits, and social good organizations become more effective.

All of our project partners collect data, and many use data in some way to evaluate their programs and write reports for their funders. However, most social good organizations have not used data science to actively inform their ongoing decisions and process. Through this program, we aim to increase awareness of the benefits and challenges of data-driven impact work, both among our partners and among non-profits and governments in general.

Our project partners are partners, not clients. This means that the fellows work with the partners, not for them. We believe that the fellowship helps both partners and fellows develop a common language. While we prioritize learning, it is important to note that part of what you are learning as a fellow is how to deliver work on a deadline.

## Building a Community of Data Scientists for Social Good
We hope and expect that your impact as a DSSG alum continues beyond the summer. Throughout the summer, we will introduce you to other practitioners within both the data science and social good spaces to help you understand these sectors, form relationships, and the potential future contributions you could make. You’ll also have the opportunity to network with local Chicago data science, tech, government, non-profit, and startup communities through regular fellowship-sponsored happy hours and Meetups.
...
The fellowship provides you with the opportunity to learn; to work on challenging, exciting, and unique projects; and to meet a lot of people with shared interests and goals. It is up to you to take advantage of these opportunities.
...
* Learn about the challenges of working on real projects that don’t have clean data, guaranteed results, or pretty solutions
* Navigate the triangle between learning technical skills, creating deliverables that are useful and actionable for your project partner, and the balance of skills within your team
* Rise to the challenge of working on a team with strong personalities and diverse experiences and strengths
...
* Explore available roles in the field of data science for social good and find the one you are best suited for, or create your own

Throughout the summer, we encourage you to share your ideas about how to improve the fellowship experience for yourself and others. We are constantly trying to improve the fellowship every day, throughout the summer, and over time as we learn from each cohort.

# Our Expectations of Fellows

The fellowship offers a lot of freedom; however, we expect all fellows to stick to the basic principles listed below at all times. The same principles apply to everybody at the fellowship, including mentors, project managers, and the fellowship organizers. If you feel that anyone is not behaving in accordance with these guidelines, we invite you to bring it up constructively. If you are unsure who to address, or if you do not feel comfortable doing so directly, you can bring up your concerns with the fellow advocate.

* **Be supportive, open-minded, and willing to compromise.** DSSG brings people from different backgrounds and with different skills. In fact, this might be the best resource the fellowship has to offer! Share your knowledge and your experience with each other. Be patient as you teach each other and have an open ear for your peers.
